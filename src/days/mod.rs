    ...
    match year {
        ...
        2022 => {
            match day {
                ...
                2 => {
                    year_2022::day_2::run_day(input);
                },
                3 => {
                    year_2022::day_3::run_day(input);
                },
                4 => {
                    year_2022::day_4::run_day(input);
                },
                5 => {
                    year_2022::day_5::run_day(input);
                },
                6 => {
                    year_2022::day_6::run_day(input);
                },
                7 => {
...
<<<<<<< HEAD
        2025 => {
            match day {
                1 => {
                    year_2025::day_1::run_day(input);
                },
                2 => {
                    year_2025::day_2::run_day(input);
                },
                3 => {
                    year_2025::day_3::run_day(input);
                },
                4 => {
                    year_2025::day_4::run_day(input);
                },
                _ => ()
            }
        },
